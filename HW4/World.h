...
namespace mtm{
    ...
    class World{
        ...
        /**
         * A private function that helps us check if a clan name alraedy
         * exiest.
         * @param
         * new_clan - the name of the new clan we want to check.
         * @return
         * true - if a clan with the same name was found .
         * false - otherwize ;
         */
        bool checkClanExiest(const string& new_clan) const {
            map<string,Clan>::const_iterator c_it = clan_map.find(new_clan);
        ...
        /**
         * A private function that helps us check if an area name alrady
         * exiest.
         * @param
         * area_name - the name of the area we want to check.
         * @return
         * true - if an area with the same name was found .
         * false - otherwize ;
         */
        bool checkAreaExiest(const string& area_name) const {
            map<string,AreaPtr>::const_iterator c_it= areas_map.find(area_name);
            if (c_it==areas_map.end()){
                return false ;
            }
            return true;
        }
        /**
         * A private function that helps us find the name of the area
         * that has the relvent group.
         * @param
         * group_name - the group we wish to find.
         * @return
         * the name of the area we found the group in .
         * "" - an empty string otherwize .
         */
        string findAreaThatHasGroup(const string& group_name) const {
            map<string,AreaPtr>::const_iterator c_it = areas_map.begin();
            while (c_it!=areas_map.end()) {
                if ((*(c_it->second)).getGroupsNames().contains(group_name)){
                    return c_it->first ;
                }
                c_it++;
            }
        ...
        /**
         * A private function that helps us find the name of the clan
         * that has the relvent group.
         * @param
         * group_name - the group we wish to find.
         * @return
         * the name of the clan we found the group in .
         * "" - an empty string otherwize .
         */
        string findClanThatHasGroup(const string& group_name) const {
            map<string,Clan>::const_iterator c_it = clan_map.begin();
            while (c_it!=clan_map.end()) {
                if ((c_it->second).doesContain(group_name)){
                    return c_it->first ;
                }
                c_it++;
            }
        ...
        /**
         * A private function that helps us make all the new united clan
         * friends , friends with the new united clan .
         * @param
         * new_clan - the name of the new Clan .
         */
        void makeFriendsUnitedClan (Clan& new_clan){
            map<string,Clan>::iterator it = clan_map.begin();
            while (it!=clan_map.end()) {
                if (new_clan.isFriend((*it).second)) {
                    (*it).second.makeFriend(new_clan);
                }
                it++;
            }
        }
        ...
        /**
         * A Praivte function that helps determent if a given group name
         * is already taken
         * @param
         ...
         * false - otherwize .
            */
        bool checkIfGroupNameExiest(const string& name) const {
