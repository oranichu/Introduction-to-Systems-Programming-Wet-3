...
bool testWorldUniteClans () {
    ...
    ASSERT_NO_EXCEPTION(w.uniteClans("TheNorth","TheSouth","TheNorth"));
    ASSERT_NO_EXCEPTION(w.addClan("PeaceClan"));
    ASSERT_EXCEPTION(w.addClan("TheSouth"),WorldClanNameIsTaken);
    ASSERT_EXCEPTION(w.uniteClans("PeaceClan","TheEast","TheSouth")
    ,WorldClanNameIsTaken);
    ASSERT_NO_EXCEPTION(w.uniteClans("PeaceClan","TheEast","NewPeaceClan"));
    return true;
}
